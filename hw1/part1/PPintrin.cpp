...
template void _pp_vset<float>(__pp_vec_float &vecResult, float value,
                              __pp_mask &mask);
template void _pp_vset<int>(__pp_vec_int &vecResult, int value,
                            __pp_mask &mask);

void _pp_vset_float(__pp_vec_float &vecResult, float value, __pp_mask &mask)
{
    _pp_vset<float>(vecResult, value, mask);
}
void _pp_vset_int(__pp_vec_int &vecResult, int value, __pp_mask &mask)
{
    _pp_vset<int>(vecResult, value, mask);
}
...
template void _pp_vmove<float>(__pp_vec_float &dest, __pp_vec_float &src,
                               __pp_mask &mask);
template void _pp_vmove<int>(__pp_vec_int &dest, __pp_vec_int &src,
                             __pp_mask &mask);

void _pp_vmove_float(__pp_vec_float &dest, __pp_vec_float &src, __pp_mask &mask)
{
    _pp_vmove<float>(dest, src, mask);
}
void _pp_vmove_int(__pp_vec_int &dest, __pp_vec_int &src, __pp_mask &mask)
{
    _pp_vmove<int>(dest, src, mask);
}
...
template void _pp_vload<float>(__pp_vec_float &dest, float *src,
                               __pp_mask &mask);
...
template void _pp_vstore<float>(float *dest, __pp_vec_float &src,
                                __pp_mask &mask);
...
{
    _pp_vstore<float>(dest, src, mask);
}
void _pp_vstore_int(int *dest, __pp_vec_int &src, __pp_mask &mask)
{
    _pp_vstore<int>(dest, src, mask);
}

template <typename T>
void _pp_vadd(__pp_vec<T> &vecResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
              __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_vadd<float>(__pp_vec_float &vecResult, __pp_vec_float &veca,
                              __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_vadd<int>(__pp_vec_int &vecResult, __pp_vec_int &veca,
...
template <typename T>
void _pp_vsub(__pp_vec<T> &vecResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
              __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_vsub<float>(__pp_vec_float &vecResult, __pp_vec_float &veca,
                              __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_vsub<int>(__pp_vec_int &vecResult, __pp_vec_int &veca,
                            __pp_vec_int &vecb, __pp_mask &mask);
...
template <typename T>
void _pp_vmult(__pp_vec<T> &vecResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
               __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_vmult<float>(__pp_vec_float &vecResult, __pp_vec_float &veca,
                               __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_vmult<int>(__pp_vec_int &vecResult, __pp_vec_int &veca,
                             __pp_vec_int &vecb, __pp_mask &mask);
...
template <typename T>
void _pp_vdiv(__pp_vec<T> &vecResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
              __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_vdiv<float>(__pp_vec_float &vecResult, __pp_vec_float &veca,
                              __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_vdiv<int>(__pp_vec_int &vecResult, __pp_vec_int &veca,
                            __pp_vec_int &vecb, __pp_mask &mask);
...
template void _pp_vabs<float>(__pp_vec_float &vecResult, __pp_vec_float &veca,
                              __pp_mask &mask);
template void _pp_vabs<int>(__pp_vec_int &vecResult, __pp_vec_int &veca,
                            __pp_mask &mask);

void _pp_vabs_float(__pp_vec_float &vecResult, __pp_vec_float &veca,
                    __pp_mask &mask)
{
    _pp_vabs<float>(vecResult, veca, mask);
}
void _pp_vabs_int(__pp_vec_int &vecResult, __pp_vec_int &veca, __pp_mask &mask)
{
    _pp_vabs<int>(vecResult, veca, mask);
}

template <typename T>
void _pp_vgt(__pp_mask &maskResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
             __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_vgt<float>(__pp_mask &maskResult, __pp_vec_float &veca,
                             __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_vgt<int>(__pp_mask &maskResult, __pp_vec_int &veca,
                           __pp_vec_int &vecb, __pp_mask &mask);

void _pp_vgt_float(__pp_mask &maskResult, __pp_vec_float &veca,
                   __pp_vec_float &vecb, __pp_mask &mask)
{
    _pp_vgt<float>(maskResult, veca, vecb, mask);
}
void _pp_vgt_int(__pp_mask &maskResult, __pp_vec_int &veca, __pp_vec_int &vecb,
                 __pp_mask &mask)
{
...
template <typename T>
void _pp_vlt(__pp_mask &maskResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
             __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_vlt<float>(__pp_mask &maskResult, __pp_vec_float &veca,
                             __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_vlt<int>(__pp_mask &maskResult, __pp_vec_int &veca,
                           __pp_vec_int &vecb, __pp_mask &mask);

void _pp_vlt_float(__pp_mask &maskResult, __pp_vec_float &veca,
                   __pp_vec_float &vecb, __pp_mask &mask)
{
    _pp_vlt<float>(maskResult, veca, vecb, mask);
}
void _pp_vlt_int(__pp_mask &maskResult, __pp_vec_int &veca, __pp_vec_int &vecb,
                 __pp_mask &mask)
{
...
template <typename T>
void _pp_veq(__pp_mask &maskResult, __pp_vec<T> &veca, __pp_vec<T> &vecb,
             __pp_mask &mask)
{
    for (int i = 0; i < VECTOR_WIDTH; i++)
    {
...
template void _pp_veq<float>(__pp_mask &maskResult, __pp_vec_float &veca,
                             __pp_vec_float &vecb, __pp_mask &mask);
template void _pp_veq<int>(__pp_mask &maskResult, __pp_vec_int &veca,
                           __pp_vec_int &vecb, __pp_mask &mask);

void _pp_veq_float(__pp_mask &maskResult, __pp_vec_float &veca,
                   __pp_vec_float &vecb, __pp_mask &mask)
{
    _pp_veq<float>(maskResult, veca, vecb, mask);
}
void _pp_veq_int(__pp_mask &maskResult, __pp_vec_int &veca, __pp_vec_int &vecb,
                 __pp_mask &mask)
{
...
template void _pp_interleave<float>(__pp_vec_float &vecResult,
                                    __pp_vec_float vec);

void _pp_interleave_float(__pp_vec_float &vecResult, __pp_vec_float vec)
{
    _pp_interleave<float>(vecResult, vec);
}
