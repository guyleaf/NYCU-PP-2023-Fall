 ...
 *
 * This approach generates a very slight bias (of the order of
 * upperbound/2**32), but in a high performance setting, it is probably quite
 * acceptable, and preferable to branching.
 *
