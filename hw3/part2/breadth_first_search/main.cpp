...
int main(int argc, char** argv)
{
    ...
    if (argc < 2)
    {
        ...
        std::cerr << "  Run with a certain number of threads (no correctness "
                     "run): <path/to/graph/file> <num_threads>\n";
        exit(1);
    }
    ...
    else
    {
        ...
        sprintf(buf, "%4d:     %8.2f     %8.2f     %8.2f\n", thread_count,
                top_time, bottom_time, hybrid_time);
