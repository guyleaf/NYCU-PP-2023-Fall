                  ...
                  std::vector<std::vector<double>>& scores)
{
    ...
    scores[idx][top_down] = compute_score(graph_name, correct,
                                          ref_top_down_time, stu_top_down_time);
    ...
    scores[idx][bott_up] = compute_score(
        graph_name, correct, ref_bottom_up_time, stu_bottom_up_time);
